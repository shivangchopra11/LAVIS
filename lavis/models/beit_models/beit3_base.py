...
from lavis.models.beit_models.embedding import (
    PositionalEmbedding, 
    TextEmbedding, 
    VisionEmbedding
)
from lavis.models.beit_models.encoder import Encoder
from lavis.models.beit_models.multiway_netwrok import MutliwayEmbedding

class BEiT3Base(BaseModel):
